...
![Windows App - Machines AI-enabled](/_sources/W365-AI-enabled/Image1.png)
...
![Nouvelle icône de recherche](/_sources/W365-AI-enabled/Image2.png)
...
![Click-To-Do dans le menu démarrer](/_sources/W365-AI-enabled/Image3.png)

Le 3e changement, plus discret, sans lequel l'IA ne fonctionnerait pas, est l'installation des 3 composants.

![Composants IA installés](/_sources/W365-AI-enabled/Image4.png)
...
![Raccourcis Click to Do](/_sources/W365-AI-enabled/Image6.png)
...
![Recherche de texte à l'écran](/_sources/W365-AI-enabled/Image7.png)

Vous pouvez ensuite le copier ou l'ouvrir directement avec l'application de votre choix.

![Options d'ouverture](/_sources/W365-AI-enabled/Image8.png)

J'ai maintenant un fichier texte contenant tout le texte capturé.

![Fichier texte créé](/_sources/W365-AI-enabled/Image9.png)
...
![Résultat de recherche sémantique](/_sources/W365-AI-enabled/Image10.png)

Instantanément après avoir pris la capture d'écran ci-dessus, le résultat de la recherche s'est mis à jour.

![Mise à jour du résultat](/_sources/W365-AI-enabled/Image11.png)
...
![Création de stratégie](/_sources/W365-AI-enabled/Image12.png)

Lui donner un nom, activer la fonctionnalité.

![Configuration de la stratégie](/_sources/W365-AI-enabled/Image13.png)

Puis assigner et créer la stratégie.

### Configurer le CPC sur le canal Insider Beta ou Release Preview

![Configuration du canal](/_sources/W365-AI-enabled/Image14.png)
...
![Cloud PC Overview](/_sources/W365-AI-enabled/Image15.png)
...
![Rapport AI-enabled Cloud PC](/_sources/W365-AI-enabled/Image16.png)
...
![Information sur l'ordinateur](/_sources/W365-AI-enabled/Image17.png)
