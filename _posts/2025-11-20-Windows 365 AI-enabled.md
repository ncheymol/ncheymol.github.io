...
![Windows App - Machines AI-enabled](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image1.png?raw=true)
...
![Nouvelle icône de recherche](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image2.png?raw=true)
...
![Click-To-Do dans le menu démarrer](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image3.png?raw=true)

Le 3e changement, plus discret, sans lequel l'IA ne fonctionnerait pas, est l'installation des 3 composants.

![Composants IA installés](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image4.png?raw=true)
...
![Message d'installation en cours](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image5.png?raw=true)
...
![Raccourcis Click to Do](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image6.png?raw=true)
...
![Recherche de texte à l'écran](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image7.png?raw=true)

Vous pouvez ensuite le copier ou l'ouvrir directement avec l'application de votre choix.

![Options d'ouverture](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image8.png?raw=true)

J'ai maintenant un fichier texte contenant tout le texte capturé.

![Fichier texte créé](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image9.png?raw=true)
...
![Résultat de recherche sémantique](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image10.png?raw=true)

Instantanément après avoir pris la capture d'écran ci-dessus, le résultat de la recherche s'est mis à jour.

![Mise à jour du résultat](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image11.png?raw=true)
...
![Création de stratégie](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image12.png?raw=true)

Lui donner un nom, activer la fonctionnalité.

![Configuration de la stratégie](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image13.png?raw=true)

Puis assigner et créer la stratégie.

### Configurer le CPC sur le canal Insider Beta ou Release Preview

![Configuration du canal](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image14.png?raw=true)
...
![Cloud PC Overview](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image15.png?raw=true)
...
![Rapport AI-enabled Cloud PC](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image16.png?raw=true)
...
![Information sur l'ordinateur](https://github.com/ncheymol/ncheymol.github.io/blob/main/_sources/W365-AI-enabled/Image17.png?raw=true)
